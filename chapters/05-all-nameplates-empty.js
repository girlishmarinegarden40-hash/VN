...
window.AliceCourtyardChapterFiles.push({
  ...
  lines: [
    ...
    },
    {
      ...
      text: "那些门牌全都空着。空得像每一道门后都曾有人来过，又谁都没能把自己的名字真正留下。"
    },
    {
      location: "门牌前",
      speaker: "A-017",
    ...
    },
    {
      ...
      text: "Yume正好站在回廊尽头，听见这句话，轻轻抬了一下眼。"
    },
    {
      location: "回廊尽头",
      speaker: "Yume",
    ...
    },
    {
      ...
      text: "也不是每一个被叫作爱丽丝的人，最后都能把自己还原成单数。"
    },
    {
      location: "回廊尽头",
      speaker: "旁白",
    ...
    },
    {
      ...
      sprites: [
        ...
        { slot: "center", src: "./assets/sprites/meiling/meiling_neutral.webp" },
        { slot: "right", src: "./assets/sprites/shella/shella_smile.webp" }
      ],
      text: "喷泉边那一个先把软垫拍平。数杯子的那一个正低头默数。另一个把点心分成两份，轻轻推向空着的位置。还有一个一直站在门边，像风里稍有一点不对，她都会先一步看见。"
    },
    {
      location: "长桌夜色",
      speaker: "旁白",
      ...
      sprites: [
        ...
        { slot: "center", src: "./assets/sprites/mizuki/mizuki_guard.webp" },
        { slot: "right", src: "./assets/sprites/a017/a017_stunned.webp", dim: true }
      ],
      text: "后来她才一个一个知道她们的名字。Azalea，Meiling，Shella，Mizuki。她们看上去都不像“活着的人”，可也不像装饰。更像被什么东西硬生生留在这里之后，仍然勉强维持着原来姿态的人。"
    },
    {
      location: "长桌夜色",
      speaker: "Meiling",
    ...
    },
    {
      ...
      text: "Hana是在那之后才走过来的。她肩上的披肩被风带歪了一点，手里那只杯子也早就凉了。Azalea什么都没问，只是很自然地把她手边那只换成热的，又顺手替她把披肩重新按回肩上。"
    },
    {
      location: "长桌夜色",
      speaker: "Azalea",
